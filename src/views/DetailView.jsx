import { Edit3, Phone, PhoneCall, Tag, Trash2, ClipboardList } from "lucide-react-native";
...
export default function DetailView({ controller, entry }) {
    ...
    const callCustomer = async () => {
        if (!phone) {
            controller.showDialog("No phone number", "This entry does not have a phone number.", "warning");
            return;
        }
        ...
        if (!supported) {
            controller.showDialog("Call unavailable", "This device cannot open the phone dialer.", "warning");
            return;
        }
        Linking.openURL(url);
    };
            ...
            <ScrollView contentContainerStyle={tw`px-5 pb-32`}>
                ...
                >
                    ...
                    <View style={tw`items-center px-5 pb-6 -mt-10`}>
                        ...
                        >
                            <ClipboardList size={34} color={dark ? "#ffffff" : "#171717"} />
                        </View>
